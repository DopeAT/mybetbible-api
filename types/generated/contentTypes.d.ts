...
export interface ApiArticleArticle extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    article_level: Attribute.Relation<
      'api::article.article',
      'manyToOne',
      'api::article-level.article-level'
    >;
...
export interface ApiArticleLevelArticleLevel extends Schema.CollectionType {
  collectionName: 'article_levels';
  info: {
    singularName: 'article-level';
    pluralName: 'article-levels';
    displayName: 'ArticleLevel';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiBonusBonus extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    title: Attribute.String;
    isWelcome: Attribute.Boolean;
    category: Attribute.Relation<
      'api::bonus.bonus',
      'oneToOne',
      'api::category.category'
    >;
    bookie: Attribute.Relation<
      'api::bonus.bonus',
      'manyToOne',
      'api::bookie.bookie'
    >;
...
export interface ApiBookieBookie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    features: Attribute.Relation<
      ...
      'api::feature.feature'
    >;
    seo: Attribute.Relation<'api::bookie.bookie', 'oneToOne', 'api::meta.meta'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::article-level.article-level': ApiArticleLevelArticleLevel;
      'api::bonus.bonus': ApiBonusBonus;
      'api::bookie.bookie': ApiBookieBookie;
